...
public class Card implements Comparable<Card> {
    ...
    public int compareTo(Card other) {
        if (this.value > other.value) { // IF THE CARD VALUES IS GREATER THAN OTHER CARD VALUE - return 1 - I.E (12th of spades
            return 1; // I.E (fourth.compareTo(third)); FOURTH IS 'THIS' CARD VALUE & THIRD IS OTHER CARD VALUE                  
        } else if (this.value == other.value) { // IF THE CARD VALUE IS EQUAL TO OTHER,
            if (this.suit > other.suit) { // CHECK THE CARD's SUITS // CLUBS > HEARTS > DIAMONDS > SPADES. ('>' is greater than)
                return 1; // I.E (tenSpades.compareTo(tenDiamonds) will return 1(the 'tenSpades' is the 'this.suits' value.)
